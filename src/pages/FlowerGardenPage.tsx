...
function HomePage() {
  ...
  useEffect(() => {
    ...
    const fetchFlowers = async () => {
      setLoading(true);
      setError(null);
      let fetchedData: FlowerList[] = [];

      if (debugMode) {
        console.log(`デバッグモード: ${flowerCount}個の花を生成します。`);
        ...
        if (error) {
          ...
          console.log('Supabaseから取得したデータ:', fetchedData);
        }
      }
  ...
  console.log(`決定された画像のサイズ: ${imageSize}`);
